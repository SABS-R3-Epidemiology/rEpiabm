...
calculate_susceptible_diff(file.path(output_dir, "output.csv"),
                           display = TRUE,
                           location =
                             file.path(output_dir, "incidence.csv"))

# Generate Generation_time distribution array and values
create_gen_time_array(file.path(output_dir, "generation_times.csv"),
                      display = TRUE, location =
                        file.path(output_dir, "gen_time_dist.csv"))
